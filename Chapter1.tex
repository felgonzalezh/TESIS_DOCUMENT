...
\multirow{2}{*}{\shortstack[c]{}}      &    \multirow{2}{*}{\shortstack[c]{Data}}      & \multirow{2}{*}{\shortstack[c]{$\sqrt{s}$ [TeV]}} &  \multirow{2}{*}{\shortstack[c]{$\mathscr{L}$ [fb$^{-1}$] }} 
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.3]{figuras/Chapter1/ATLASZprime2ditaufigure.pdf}
\caption{Upper limit at the 95$\%$ CL on the product of the cross section and
branching fraction into $\tau$ pairs as a function of the \Zprime~mass. The bands represent the
...
Since \Zprime~bosons might decay into quark-antiquark pairs, the CMS and
