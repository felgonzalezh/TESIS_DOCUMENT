...
\begin{tiny} 
 ...
 TTbar      & 0.56   $\pm$   0.44  & 0.34   $\pm$   0.34 \\ \hline 
...
implies that the same method can be used to estimate QCD background in the signal region.\\
 ...
 \captionsetup[subfloat]{farskip=0pt,captionskip=0.0cm,labelformat=empty}
 \resizebox{\textwidth}{8.8cm}{
 \includegraphics[clip,width=0.4\textwidth]{figuras/Chapter5/QCD_Estimation/CR_B.pdf}
 \includegraphics[clip,width=0.4\textwidth]{figuras/Chapter5/QCD_Estimation/CR_B_log.pdf}
 }
 \end{center}
...
the signal is expected.\\
 ...
 TTbar      & 4.39   $\pm$   1.23  & 1.04   $\pm$   0.60 \\ \hline 
...
AN nuestro
We consider a 30% uncertainty on the mis-tag rate as mea-
...
the 30% uncertainty on the mis-tag rate through the following equation (which rep-
...
ability to obtain at least one additional jet in the event is ∼ 10%. Therefore, based on
the above equation, the mis-tag rate and uncertainty, and the probability to obtain at
least one additional jet we calculate a systematic effect of ∼ 5% on our signal due to
the mis-tag rate. The b-tagging/mis-tagging systematics are considered 100% cor-
